...
namespace Bitget.Net.UnitTests
{
    ...
    public class RestRequestTests
    {
        ...
        public async Task ValidateUnifiedExchangeDataCalls()
        {
            ...
            await tester.ValidateAsync(client => client.UnifiedApi.ExchangeData.GetKlinesAsync(ProductCategory.Spot, "ETHUSDT", Enums.Uta.KlineInterval.OneMinute), "GetKlines", nestedJsonProperty: "data");
            await tester.ValidateAsync(client => client.UnifiedApi.ExchangeData.GetKlineHistoryAsync(ProductCategory.Spot, "ETHUSDT", Enums.Uta.KlineInterval.OneMinute), "GetKlineHistory", nestedJsonProperty: "data");
