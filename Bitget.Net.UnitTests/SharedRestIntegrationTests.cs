...
namespace Bitget.Net.UnitTests
{
    ...
    internal class SharedRestIntegrationTests
    {
        ...
        private IBitgetRestClientSpotApiShared GetSpotRestClient()
        {
            var collection = new ServiceCollection();
            collection.AddBitget(x => x.Rest.OutputOriginalData = true);
            ...
            return sp.GetRequiredService<IBitgetRestClient>().SpotApiV2.SharedClient;
        }

        private IBitgetRestClientFuturesApiShared GetFuturesRestClient()
        {
            ...
            var sp = collection.BuildServiceProvider();
            return sp.GetRequiredService<IBitgetRestClient>().FuturesApiV2.SharedClient;
        }
