...
namespace Bitget.Net.Clients.SpotApi
{
    ...
    internal class BitgetRestClientSpotApi : RestApiClient, IBitgetRestClientSpotApi, ISpotClient
    {
        ...
        /// <inheritdoc />
        public override string FormatSymbol(string baseAsset, string quoteAsset, ApiType apiType, DateTime? deliverTime = null) => baseAsset.ToUpperInvariant() + quoteAsset.ToUpperInvariant() + "_SPBL";
