...
namespace Bitget.Net.Clients.UnifiedApi
{
    ...
    internal class BitgetRestClientUnifiedApiAccount : IBitgetRestClientUnifiedApiAccount
    {
        ...
        /// <inheritdoc />
        public async Task<HttpResult<BitgetUaFundingFinancialRecordPage>> GetFundingFinancialRecordsAsync(
            string? asset = null,
            string? type = null,
            DateTime? startTime = null,
            DateTime? endTime = null,
            ...
            CancellationToken ct = default)
        {
            ...
            var result = await _baseClient.SendAsync<BitgetUaFundingFinancialRecordPage>(request, parameters, ct).ConfigureAwait(false);
            return result;
        }
