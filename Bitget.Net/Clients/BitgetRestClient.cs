...
namespace Bitget.Net.Clients
{
    ...
    public class BitgetRestClient : BaseRestClient, IBitgetRestClient
    {
        ...
        /// <inheritdoc />
        public Interfaces.Clients.CopyTradingApiV2.IBitgetRestClientCopyTradingApi CopyTradingV2 { get; }
        ...
        public BitgetRestClient(HttpClient? httpClient, ILoggerFactory? loggerFactory, IOptions<BitgetRestOptions> options) : base(loggerFactory, "Bitget")
        {
            ...
            CopyTradingV2 = AddApiClient(new CopyTradingApiV2.BitgetRestClientCopyTradingApi(_logger, httpClient, this, options.Value));
        }
        ...
        public void SetOptions(UpdateOptions options)
        {
            ...
            CopyTradingV2.SetOptions(options);
        }
        ...
        public void SetApiCredentials(BitgetApiCredentials credentials)
        {
            ...
            CopyTradingV2.SetApiCredentials(credentials);
        }
