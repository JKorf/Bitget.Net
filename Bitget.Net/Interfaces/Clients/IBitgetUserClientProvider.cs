...
namespace Bitget.Net.Interfaces.Clients
{
    ...
    /// </summary>
    public interface IBitgetUserClientProvider : IExchangeService
    {
        /// <summary>
        ...
        void InitializeUserClient(string userIdentifier, BitgetCredentials credentials, BitgetEnvironment? environment = null);
        ...
        /// <param name="environment">The environment to use</param>
        IBitgetRestClient GetRestClient(string userIdentifier, BitgetCredentials? credentials = null, BitgetEnvironment? environment = null);
        ...
        /// <param name="credentials">The credentials for the user. Required the first time a client is requested for this user unless <see cref="InitializeUserClient" /> has been called prior for this user.</param>
        /// <param name="environment">The environment to use</param>
        IBitgetSocketClient GetSocketClient(string userIdentifier, BitgetCredentials? credentials = null, BitgetEnvironment? environment = null);
    }
}