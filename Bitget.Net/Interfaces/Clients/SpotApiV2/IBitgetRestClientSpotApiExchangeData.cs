...
namespace Bitget.Net.Interfaces.Clients.SpotApiV2
{
    ...
    public interface IBitgetRestClientSpotApiExchangeData
    {
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<IEnumerable<BitgetKline>>> GetHistoricalKlinesAsync(string symbol, BitgetKlineInterval interval, DateTime? endTime = null, int? limit = null, CancellationToken ct = default);
