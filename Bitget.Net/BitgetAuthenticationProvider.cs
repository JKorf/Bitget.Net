...
namespace Bitget.Net
{
    internal class BitgetAuthenticationProvider : AuthenticationProvider<BitgetApiCredentials>
    {
            ...
            RequestBodyFormat requestBodyFormat)
        {
            ...
            var signString = timestamp + method.ToString().ToUpperInvariant() + uri.AbsolutePath + (parameterPosition == HttpMethodParameterPosition.InUri ? "?" + uriParameters?.CreateParamString(false, arraySerialization) : "") + body;
